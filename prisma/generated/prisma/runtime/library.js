...
function st(
  ...
  return (
    ...
    i?.dotenvResult.error
      ? console.log(ce(W("Schema Env Error: ")) + i.dotenvResult.error)
      : {
...
async function df(e, r) {
  ...
  if (o !== void 0 || n === "0.0.0" || n === "in-memory") {
    ...
    try {
      ...
      throw (
        console.log("JSON.parse error: body fetched from unpkg.com: ", d),
        h
      );
    }
    return f.version;
