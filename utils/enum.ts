...
export enum RelativeRoutes {
  ...
  TECH_ADMIN_HOMEPAGE = "/tech-admin",
  TECH_ADMIN_LOGS = "/tech-admin/logs",
  SUPER_ADMIN_HOMEPAGE = "/super-admin",
  ...
  PASSWORD_RESET_SUCCESS_PAGE = "/password-reset",
  CHANGE_INITIAL_PASSWORD_PAGE = "/change-initial-password",
  MENTEE_SIGNUP_PAGE = "/mentee-sign-up",
  MENTOR_SIGNUP_PAGE = "/mentor-sign-up",
  MENTEE_PROGRAM_PAGE = "/mentee/program",
  MENTEE_ENROLLMENTS_PAGE = "/mentee/enrollments",
  MENTEE_ACCOUNT_PAGE = "/mentee/account",
  MENTEE_LIBRARY_PAGE = "/mentee/library",
}
